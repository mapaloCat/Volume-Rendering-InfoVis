...
class TransferFunction:
    ...
    def set_test_function(self):
        ...
        self.add_control_point(40, 1., .0, .0, .2)
        self.add_control_point(50, 1., .0, .0, .4)
        ...
        # self.add_control_point(15751, 0., 0., .0, .0)
        # self.add_control_point(16966, 0., .0, .0, .0)
        # self.add_control_point(16967, .757, .38, .827, 0.2)
        # self.add_control_point(16968, 0., 0., .0, .0)
        # self.add_control_point(16381, 0., .0, .0, .0)
        # self.add_control_point(16382, .7, 1., .4, 0.2)
        # self.add_control_point(16383, 0., 0., .0, .0)
        # self.add_control_point(16657, 0., .0, .0, .0)
        # self.add_control_point(16658, .6, .8, 1., 0.2)
        # self.add_control_point(16659, 0., 0., .0, .0)
